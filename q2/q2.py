            ...
            vehicles.append(
                {
                    ...
                    "color": color_name,
                    "lane": lane,
                    "make": None,          # your model can fill this if trained for brands
                    "logo_bbox": None,
...
def analyze_folder(
    ...
    os.makedirs(os.path.join(folder_path, json_folder), exist_ok=True)
    if save_annotated:
        os.makedirs(os.path.join(folder_path, annotated_folder), exist_ok=True)
        ...
        if filename.lower().endswith((".jpg", ".jpeg", ".png")):
            ...
            if save_json:
                json_path = os.path.join(
                    folder_path, json_folder, f"{os.path.splitext(filename)[0]}.json"
                )
            ...
            if save_annotated:
                ...
                save_path = os.path.join(folder_path, annotated_folder, filename)
...
if __name__ == "__main__":
    folder = "q2/q2_Images"  # your input image folder
